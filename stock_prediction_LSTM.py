...
df= pd.read_csv('TATAPOWER_01-03-2018_03-03-2019.csv')
print(df)
...
plt.ylabel('Midsize',fontsize=14)
plt.show()

# First calculate the mid prices from the highest and lowest
high_prices = df.loc[:,'High Price'].as_matrix()
low_prices = df.loc[:,'Low Price'].as_matrix()
...
for di in range(0,150,smoothing_window_size):
...
test_points_seq = np.arange(200,240,5).tolist()
